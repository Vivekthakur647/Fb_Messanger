...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    @nonobjc func application(_ application: UIApplication, open url: URL, sourceApplication: String, annotation: Any) -> Bool {
...
//        }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Fb_Messanger")
